  ...
  return (
    ...
    <Row>
        ...
        <div className='text-center '>
            ...
            <div style={paraStyles}>Email: {compLogo=="1"?"info@ifa.com.pk":"info@ifa.com.pk"}   Web: {compLogo=="1"?"www.ifa.com.pk":"www.acs.com.pk"}</div>
    ...
    <div style={{position:'fixed', bottom:30, width:'90vw'}}>
        <Row className='justify-content-center'>
            ...
            <Col md={4} className='text-center'>
                ...
                <div className='fs-12 px-5'><b>{compLogo=="1"?"International Freight Aviation & LOGISTICS":"AIR CARGO SERVICES"}</b></div>
            </Col>
        </Row>
    </div>
    <div style={{position:'fixed', bottom:30, width:'90vw'}}>
