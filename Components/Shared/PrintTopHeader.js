  ...
  return (
    ...
    <div className="d-flex justify-content-between" >
        <div style={{width:"20%"}} className="text-center">
            <img src={company=='1'?"/ifa-logo.png":company=='3'?"/aircargo-logo.png":"/cargolinkers-logo.png"} className="invert" width={130}/>
        </div>
        <div style={{width:"60%"}} className="text-center">
            <h5>
                <b>
                    {company=='1'?"International Freight Aviation & LOGISTICS":company=='2'?"CARGO LINKERS":"AIR CARGO SERVICES"}
                </b>
            </h5>
            <div className="fs-13">
