                  ...
                  state.fields.chargeList.forEach(async (y, i) => {
                    if (y.code == e) {
                        ...
                        for (let priceIndex = 0; priceIndex < y?.pricing?.length; priceIndex++) {
                          if(priceIndex+1 != y.pricing.length){
                            if(tempChargeList[index].qty<=y.pricing[priceIndex].minimum){
                              tempChargePerPiece = y.pricing[priceIndex].amount
                              break
                            }
                          } else if(priceIndex+1 == y.pricing.length) {
                            tempChargePerPiece = y.pricing[priceIndex].amount
                          }
                        }
                      }
                      ...
                      if (state.chargesTab == '1') {
                        tempChargeList[index].invoiceType = "Job Invoice";
                      } else {
                        tempChargeList[index].invoiceType = "Job Bill";
                      }
