      ...
      <div style={{ display: "none" }}>
        <div ref={(response) => (inputRef = response)} style={{ padding: "30px" }}>
          <div className="d-flex justify-content-center" style={{ position:"relative", borderBottom: "2px solid" }}>
            <img src="/ifa-logo.png" height={40} className="invert" style={{ position:"absolute", left:"0"}}/>
            <div style={{ textAlign: "center" }}>
              <p className="fs-16" style={{ lineHeight: "5px" }}>
                International Freight Aviation & LOGISTICS
              </p>
              ...
              <p className="fs-13" style={{ lineHeight: "5px" }}>
                Email: info@ifa.com.pk.com Web www.ifa.com.pk
              </p>
            </div>
          ...
          <div style={{display:"flex", justifyContent:"space-between"}}>
            <div style={{width:"40%"}}>
                ...
                <br/>
                <hr/>
                <p><b>For : For International Freight Aviation & LOGISTICS</b></p>
