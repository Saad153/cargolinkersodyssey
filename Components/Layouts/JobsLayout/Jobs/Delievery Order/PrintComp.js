      ...
      {data.jobNo ?<div className='pb-5 px-5 pt-4'>
        <Row>
          <Col md={4} className='text-center'>
            {companyId == "1" ?
              <>
                <img src={'/ifa-logo.png'} style={{ filter: `invert(0.5)` }} height={100} />
          ...
          <Col className='mt-4'>
            <div className='text-center '>
              <div style={{ fontSize: 20 }}><b>{companyId == "1" ? "International Freight Aviation & LOGISTICS" : "AIR CARGO SERVICES"}</b></div>
              ...
              <div style={paraStyles}>Email: {companyId == "1" ? "info@ifa.com.pk" : "info@acs.com.pk"}   Web: {companyId == "1" ? "www.ifa.com.pk" : "www.acs.com.pk"}</div>
        ...
        <Row>
          <Col>
            <span className="fs-12">
              <strong>
                {companyId == "1" ? "International Freight Aviation & LOGISTICS" : "AIR CARGO SERVICE"}
              </strong>
            </span>
          </Col>
        </Row>
